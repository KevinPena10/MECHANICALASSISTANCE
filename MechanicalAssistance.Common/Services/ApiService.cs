    ...
    public class ApiService : IApiService
    {
        ...
        public async Task<Response> RegisterUserAsync(string urlBase, string servicePrefix, string controller, UserRequest userRequest)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    Response obj2 = JsonConvert.DeserializeObject<Response>(answer);
                    return new Response
                    {
                        IsSuccess = false,
        ...
        public async Task<Response> GetUserByEmail(string urlBase, string servicePrefix, string controller, string tokenType, string accessToken, EmailRequest email)
        {
            try
            {
        ...
        public async Task<Response> NewProductAsync(string urlBase, string servicePrefix, string controller, ProductRequest productlRequest, string tokenType, string accessToken)
        {
            try
            {
                string request = JsonConvert.SerializeObject(productlRequest);
                StringContent content = new StringContent(request, Encoding.UTF8, "application/json");
                HttpClient client = new HttpClient
                {
                    BaseAddress = new Uri(urlBase)
        ...
        public async Task<Response> NewRequestAsync(string urlBase, string servicePrefix, string controller, RequestServiceRequest Request, string tokenType, string accessToken)
        {
            try
            {
        ...
        public async Task<Response> UpdateRequestAsync(string urlBase, string servicePrefix, string controller, RequestServiceRequest Request, string tokenType, string accessToken)
        {
            try
            {
                string request = JsonConvert.SerializeObject(Request);
